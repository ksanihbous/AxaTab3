...
--  TAB 15: "Spear Fishing PRO++ (AutoFarm + Harpoon/Basket/Bait Shop + AimLock + Fish ESP)"
--==========================================================
...
-- Folder ikan di dunia (sesuai bocoran: WorldSea -> Sea1/Sea2/Sea3 -> Fish*)
...
local function createMainLayout()
    ...
    subtitle.Text = "AutoFarm Spear v1 + v2 (Trackpad) + AutoEquip + Harpoon / Basket / Bait Shop + Aim Lock Nearest + Fish ESP"
...
local controlCard, _, _ = createCard(
    bodyScroll,
    "Spear Controls",
    "AutoFarm v1 + AutoFarm v2 (Tap Trackpad Left/Center) + AutoEquip + Sell All + Aim Lock Nearest + Fish ESP.",
    1,
    286
)
...
statusLabel.Text = "Status: AutoFarm OFF, AutoEquip OFF, AutoFarm V2 OFF (Center), AimLock OFF, ESP OFF."

local function updateStatusLabel()
    statusLabel.Text = string.format(
        "Status: AutoFarm %s, AutoEquip %s, AutoFarm V2 %s (%s), AimLock %s, ESP %s.",
